...
/**
 * \file constants.hpp
 * Minimal, portable definitions of XL 12 constants from XLCALL.H.
 *  
 * Win32 types changed to C standard types. Excludes typedefs RW, COL, IDSHEET,
 * BOOL and XCHAR.
 *  
 * \sa https://docs.microsoft.com/en-us/office/client-developer/excel/creating-xlls#xlcallh
 */
...
enum XLTYPE : uint32_t {
    ...
    xltypeSRef    = 0x0400,
    xltypeInt     = 0x0800,
    xltypeBigData = 0x0802 // xltypeStr | xltypeInt
};
...
constexpr int xlGetFmlaInfo       = 14 | xlSpecial; // Only valid for calls to LPenHelper
constexpr int xlGetMouseInfo      = 15 | xlSpecial; // Only valid for calls to LPenHelper
...
constexpr int htTopLeft   = 0x08; // size handle
constexpr int htBotLeft   = 0x09; // size handle
constexpr int htLeft      = 0x0A; // size handle
constexpr int htTopRight  = 0x0B; // size handle
constexpr int htBotRight  = 0x0C; // size handle
constexpr int htRight     = 0x0D; // size handle
constexpr int htTop       = 0x0E; // size handle
constexpr int htBot       = 0x0F; // size handle
